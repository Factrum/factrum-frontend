...
const ResultStep2 = ({ data, onNext }) => {
    const effectList = data.prescription1[2].effects;

  return (
    <>
        <HeaderBarImage src={HeaderBar} />
        <SubTitle>1. {data.prescription1[0].drugName}</SubTitle>
        <Description>
            {data.prescription1[1].explain}
        </Description>
