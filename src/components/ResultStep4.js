...
import HeaderBar from '../assets/images/header_bar3.png';
...
const ResultStep4 = ({ data, onNext }) => {
  const prescription = data.prescription2;

  return (
    <>
      <HeaderBarImage src={HeaderBar} />
      <SubTitle>2. {prescription[0].drugName}</SubTitle>
      <Description>{prescription[1].explain}</Description>

      <EffectTitle>
        <Icon src={IdeaIcon} />
        복약 후 기대되는 효과
      </EffectTitle>
      <EffectList effects={prescription[2].effects} />
